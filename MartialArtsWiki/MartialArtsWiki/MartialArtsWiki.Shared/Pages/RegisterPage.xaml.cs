...
namespace MartialArtsWiki.Pages
{
    ...
    public sealed partial class RegisterPage : Page
    {
        ...
        private async void ShowRegisterError ()
        {
        ...
        private async void BtnSubmitRegistration (object sender, RoutedEventArgs e)
        {
            var isRegisterSuccessful = await this.ViewModel.PerformRegister();
