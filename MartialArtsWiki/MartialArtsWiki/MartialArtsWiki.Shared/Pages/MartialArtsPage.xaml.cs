...
namespace MartialArtsWiki.Pages
{
    ...
    /// </summary>
    public sealed partial class MartialArtsPage : Page
    {
        private NavigationHelper navigationHelper;
        private ObservableDictionary defaultViewModel = new ObservableDictionary();
        private MartialArtsPageViewModel viewModel;

        public MartialArtsPage()
            : this(new MartialArtsPageViewModel())
        {

        }

        public MartialArtsPage (MartialArtsPageViewModel viewModel)
        {
        ...
        private void NavigationHelper_LoadState (object sender, LoadStateEventArgs e)
        {
            ...
            this.ViewModel.LoadMartialArts(category);
        }
        ...
        private void NavigateOnAddEntry (object sender, RoutedEventArgs e)
        {
            this.Frame.Navigate(typeof(AddEntryPage), this.ViewModel.Category);
        }

        private void OnMartialArtSelect (object sender, SelectionChangedEventArgs e)
        {
            var martialArt = e.AddedItems.First() as MartialArtViewModel;
            if (martialArt == null)
            {
                return;
            }

            this.Frame.Navigate(typeof(MartialArtDetailsPage), martialArt);
        }
    }
}
